<template>
  <v-container>
    <v-row class="">
      ...
      <p>
        20yuteo（以下「当方」）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
      </p>
      <h2>
        第1条（個人情報）
      </h2>
      ...
      <div>
        本ポリシーに関するお問い合わせは，<a href="https://twitter.com/20yuteo">こちらまで</a>
      </div>
      <p>
        以上
      </p>
